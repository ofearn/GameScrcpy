<template>
  <div class="gs-logo q-electron-drag" @contextmenu.prevent="event.preventDefault()">
    <q-icon class="gs-logo-svg" size="36px">
      <svg
        version="1.1"
        id="gameScript"
      ...
      >
        <defs xmlns="http://www.w3.org/2000/svg">
          <linearGradient x1="100%" y1="0%" x2="0%" y2="100%" id="color">
        ...
        <g id="logo">
          <path
            d="M171.48,66.22c-5.32-6.32-12.05-10.73-19.25-14.52c-5.75-3.02-11.6-5.83-17.8-7.82
		...
		c27.99,1.59,53.65,18.04,66.78,42.83c0.78,1.48,1.49,3,2.23,4.5C171.31,65.77,171.39,66,171.48,66.22z"
            fill="url(#color)"
          />
        </g>
      </svg>
    </q-icon>
    <div class="gs-logo-title">GameScrcpy</div>
  </div>
</template>
<script lang="ts">
