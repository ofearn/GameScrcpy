...
public class ScreenEncoder implements Device.RotationListener {
    ...
    public ScreenEncoder(boolean sendFrameMeta, int bitRate, int maxFps, List<CodecOption> codecOptions, String encoderName, boolean sendVideo) {
